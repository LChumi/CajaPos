    ...
    private static void mapCampo(PagoResponse r, String cc, String v) {
        switch (cc) {
            ...
            case "20":
                ...
                break;
            case "22":
                r.setPanEncriptado(v);
                break;
            case "24":
                r.setFechaVencimiento(v);
                break;
            case "25":
                r.setMensajeResultado(v);
                break;
            case "26":
                r.setCodigoRed(v);
                break;
            case "27":
                r.setTarjetaTruncada(v);
                break;
            case "28":
                r.setInteres(v);
                break;
            ...
            case "42":
                ...
                break;
            case "43":
                r.setMontoMaxidolar(v);
                break;
            case "45":
                r.setNumTarjetaPayClub(v);
                break;
            case "50":
                r.setGrupoTarjeta(v);
                break;
